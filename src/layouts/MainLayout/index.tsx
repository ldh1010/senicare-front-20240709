...
import { ACCESS_TOKEN, AUTH_ABSOLUTE_PATH, CS_ABSOLUTE_PATH, CS_PATH, HR_ABSOLUTE_PAHT, HR_PATH, MM_ABSOLUTE_PAHT, MM_PATH, ROOT_ABSOLUTE_PATH } from 'src/constants';
    ...
    return (
        <div id='layout-side-navigation'>
            <div className='navigation'>
                ...
                <div className={`navigation-item ${isMm ? 'active' : ''}`} onClick={() => onItemClickHandler(MM_ABSOLUTE_PAHT)}>
                    <div className={`icon ${isMm ? 'mm-active-icon' : 'mm-icon'}`}></div>
                    <div className='item-text'>용품 관리</div>
                </div>
                <div className={`navigation-item ${isHr ? 'active' : ''}`} onClick={() => onItemClickHandler(HR_ABSOLUTE_PAHT)}>

...
import { ACCESS_TOKEN, CS_DETAIL_ABSOLUTE_PATH, CS_UPDATE_ABSOLUTE_PATH, CS_WRITE_ABSOLUTE_PATH, CS_WRITE_PATH } from 'src/constants';
...
export default function CS() {
    ...
    // effect: 컴포넌트 로드시 고객 라스트 불러오기 함수 //
            ...
            <div className='main'>
                <div className='table'>
                    <div className='th'>
                        ...
                        <div className='td-customer-location'>자역</div>

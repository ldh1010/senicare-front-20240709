...
export default function CSWrite() {
    ...
    const onSearchButtonClickHandler = () => {
        const seachedNurseList = originalList.filter(nurse => nurse.name.includes(searchWord));
        setTotalList(seachedNurseList);
        initViewList(seachedNurseList);
    };
